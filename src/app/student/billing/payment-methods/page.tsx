...
import { mockStudentPaymentMethods } from "@/lib/billing/mock-billing-data";
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="aurora-panel neon-border mb-6 rounded-lg p-6">
        ...
        <h1 className="mt-3 text-3xl font-black text-surface-0">Student payment methods</h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-ink-300">
          Prototype billing · No real payment is processed, and no cards or accounts are saved.
        </p>
      </section>
