...
export function ComparisonSection() {
  return (
    <section className="bg-surface-0 py-20 md:py-24" id="employers">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 md:items-stretch">
          ...
          <Card className="border-ink-900 bg-ink-900 p-8 text-surface-0 shadow-2xl md:scale-[1.03]">
